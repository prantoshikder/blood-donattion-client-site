import { Smartphone, Apple, Bell, MapPin, Zap } from "lucide-react";
      ...
      <div className="grid items-center gap-10 rounded-3xl border border-slate-200 bg-white p-7 shadow-sm sm:p-10 md:grid-cols-2 md:gap-14 md:p-14">
        <div>
          ...
          <div className="mt-7 flex flex-col gap-3 sm:flex-row">
            <button className="inline-flex min-h-[52px] items-center justify-center gap-3 rounded-2xl bg-slate-900 px-5 text-white transition hover:bg-slate-800">
        ...
        <div className="relative mx-auto w-full max-w-sm">
          <div className="absolute inset-0 -z-10 bg-gradient-to-br from-brand-200/50 via-rose-100/50 to-amber-100/30 blur-2xl" />
          <div className="relative rotate-2 rounded-[2rem] border-[10px] border-slate-900 bg-white p-4 shadow-2xl">
            <div className="rounded-2xl bg-gradient-to-br from-brand-50 via-white to-rose-50 p-5">
              ...
              <div className="mt-4 rounded-2xl bg-white p-4 shadow-md ring-1 ring-slate-100">
                ...
                <p className="mt-1 text-xs text-slate-500">2.3 km away • 12 min ago</p>
              ...
              <div className="mt-3 grid grid-cols-3 gap-2">
                {["A+", "B+", "O+"].map((b) => (
                  <div key={b} className="rounded-xl bg-white py-2 text-center text-xs font-semibold text-slate-700 shadow-sm">
                    {b}
                  </div>
                ))}
              </div>
