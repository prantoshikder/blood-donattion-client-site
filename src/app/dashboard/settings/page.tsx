...
import { settingsTabs as tabs } from "@/temp/dashboardData";
import {
  Bell,
  Camera,
  Lock,
  ...
  return (
    <div className="space-y-5 sm:space-y-6">
      ...
      <div className="card overflow-hidden p-0!">
        <div
          className="flex gap-1 overflow-x-auto border-b border-slate-100 px-2"
        ...
        {active === 0 && (
          <div className="grid gap-6 p-4 sm:gap-8 sm:p-6 lg:grid-cols-3">
            <div className="lg:col-span-1">
              <div className="rounded-2xl border border-slate-100 bg-linear-to-br from-brand-50 to-rose-50 p-6 text-center">
                <div className="relative mx-auto h-24 w-24">
                  <div className="grid h-full w-full place-items-center rounded-full bg-linear-to-br from-brand-500 to-rose-600 text-2xl font-bold text-white">
                    SR
                  </div>
                ...
                <button className="btn-outline mt-4 w-full py-2!">
                  Change photo
                </button>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    defaultValue="sadia@reddrop.app"
                  />
                </div>
              </div>
            ...
            <div className="rounded-2xl border border-slate-100 p-5">
              <div className="flex items-center gap-3">
                ...
                <label className="ml-auto relative inline-flex cursor-pointer items-center">
                  ...
                  />
                  <div className="peer h-6 w-11 rounded-full bg-slate-200 after:absolute after:left-0.5 after:top-0.5 after:h-5 after:w-5 after:rounded-full after:bg-white after:transition-all after:content-[''] peer-checked:bg-brand-600 peer-checked:after:translate-x-full" />
                </label>
              </div>
            </div>
          </div>
        ...
        {active === 2 && (
          <div className="space-y-3 p-4 sm:p-6">
            {[
              {
                t: "Emergency request alerts",
                d: "When someone nearby needs your blood type",
              },
              {
                t: "Donation reminders",
                d: "When you're eligible to donate again",
              },
              ...
              <div
                key={n.t}
                className="flex items-center gap-3 rounded-2xl border border-slate-100 p-5"
              >
        ...
        {active === 3 && (
          <div className="space-y-3 p-4 sm:p-6">
            {[
              {
                t: "Show my profile publicly",
                d: "Anyone can see your donor profile",
              },
              {
                t: "Show contact info to requesters",
                d: "Receivers can see your phone number",
              },
              {
                t: "Allow location-based matching",
                d: "Find donors near your area",
              },
            ].map((n, i) => (
              <div
                key={n.t}
