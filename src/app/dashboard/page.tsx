import {
  dashboardMonthly as monthly,
  dashboardRequests as requests,
  ...
  return (
    <div className="space-y-5 sm:space-y-6">
        ...
        {stats.map((s) => (
          <div key={s.label} className="card p-4! sm:p-5!">
            <div className="flex items-start justify-between gap-2">
              <div
                className={`grid h-10 w-10 place-items-center rounded-xl bg-linear-to-br ${s.color} text-white shadow-md sm:h-11 sm:w-11`}
              >
      ...
      <div className="grid gap-5 sm:gap-6 lg:grid-cols-3">
          ...
          <div className="mt-6 flex h-44 items-end gap-1.5 sm:mt-8 sm:h-56 sm:gap-3">
            {monthly.map((v, i) => (
              ...
              >
                ...
                <div
                  className="w-full rounded-t-lg bg-linear-to-t from-brand-600 to-brand-400 transition group-hover:from-brand-700 group-hover:to-brand-500"
        ...
        {/* Eligibility */}
        <div className="card relative overflow-hidden bg-linear-to-br from-brand-600 via-rose-600 to-brand-700 text-white">
          ...
          <p className="mt-2 text-xs text-white/80">
            75% recovered since last donation
          </p>
          ...
          <div className="card">
            ...
            <div className="mt-4 space-y-2">
              {[
                ...
                >
                  <span
                    className={`grid h-9 w-9 shrink-0 place-items-center rounded-lg ${q.c}`}
                  >
              ...
              {Array.from({ length: 18 }).map((_, i) => (
                <div
                  ...
                  className={`aspect-square rounded-md ${
                    i < 12
                      ? "bg-linear-to-br from-brand-500 to-rose-600"
                      : "bg-slate-100"
                  }`}
                />
              ))}
